...
public class Reports extends BaseClass {
	...
	public Map<String, List<String>> verifyReport(String reportName, ExtentTest logger) {
		...
		try {
			...
			if(reportName.contains(ReportsConstant.REVERSE_SHARED_INT_TEXT)){
				...
				verifyReverseTocToStandardViaIntermediaryReportReportData(worksheet, reportName, logger);
			}
	...
	public Map<String, List<String>> verifyScoresAndStrengthReverseDirectReport(Map<String, List<String>> productCSRepMap,
		...
		try {
			...
			if (correlationList.equals(ReportsConstant.Corr_Product)) {
				...
				logger.log(LogStatus.FAIL, "TC_LOMT_1761: Correlation scores mismatch");
			}
			if (strengthList.equals(ReportsConstant.strength_List)) {
			} else {
				logger.log(LogStatus.FAIL,
						"TC_LOMT_1761: Strength values not as expected in the exported report");
			}
		} catch (Exception e) {
			logger.log(LogStatus.FAIL,
					"TC_LOMT_1761: Error occured while veryfying Score and statements");
		}
		return productCSRepMap;
	}
		...
		try {
			...
			if (worksheet.getRow(LOMTConstant.ZERO).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.ZERO).getCell(LOMTConstant.ONE).getStringCellValue() != null
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Title value does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Title does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.ONE).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.ONE).getCell(LOMTConstant.ONE).getStringCellValue()
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-User name does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : User does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.TWO).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (isValidFormat(
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Date/time of generation format does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Date/time of generation does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.THREE).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.THREE).getCell(LOMTConstant.ONE).getStringCellValue()
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Alignments value(Central/Peripheral) does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Alignments does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FIVE).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Content does not match in exported file");
			}
			// Standard
			if (worksheet.getRow(LOMTConstant.FIVE).getCell(LOMTConstant.SEVEN).getStringCellValue().trim()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Standard does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SIX).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.SIX).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Program value should not be null in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Program does not match in exported file");
			}
			// Title
			if (worksheet.getRow(LOMTConstant.SIX).getCell(LOMTConstant.SEVEN).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.SIX).getCell(LOMTConstant.EIGHT) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Curriculum Standard should not be null in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Standard does not match in exported file");
			...
			if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Course is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Course does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.SEVEN).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.EIGHT) != null) {
					...
					count++;
					logger.log(LogStatus.INFO, "TC_LOMT-1837-Country is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Country does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.ONE).getStringCellValue()
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Product Name does not match in the exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Product does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.SEVEN).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.EIGHT) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Grade is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Grade does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.NINE).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.NINE).getCell(LOMTConstant.ONE) != null) {
					...
					logger.log(LogStatus.INFO, "TC_LOMT-1837-Geographic Area or Country is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Geographic Area or Country does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.TEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.TEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-State or Region is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : State or Region does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.ELEVENTH).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.ELEVENTH).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Start Grade is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Start Grade does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.TWELEVE).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.TWELEVE).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-End Grade is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : End Grade does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.THIRTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.THIRTEEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-ISBN10 is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : ISBN10 does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FOURTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.FOURTEEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-ISBN13 is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : ISBN13 does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FIFTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.FIFTEEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT-1837-Type is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Type does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : COMPONENT TOC does not match in exported file");
			}
			// Start Page
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.ONE).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Start Page does not match in exported file");
			}
			// End Page
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.TWO).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : End Page does not match in exported file");
			}
			// Correlation Score
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.THREE).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Correlation Score does not match in exported file");
			}
			// Strength
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.FOUR).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Strength does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.FIVE).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Peripheral Alignments does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.THIRTEEN).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT-1837-Header : Peripheral Alignments for Standard does not match in exported file");
			}
			if (count>0){
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_02_VERIFY_REPORT);
			}
			else{
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_02_VERIFY_REPORT);
			}
		} catch (Exception e) {
			logger.log(LogStatus.FAIL, "TC_LOMT-1837-Error occured while report header verification");
			e.printStackTrace();
		}
	}
	...
	public Map<String, List<String>> getProductAndCurriculumDataFromExportedSheet(XSSFSheet worksheet,
		...
		try {
			...
			//Verify Correlation Score for B-Side LOMT-2242
			if(reportType.equalsIgnoreCase(ReportsConstant.REVERSE_DIRECT_TEXT)){
				if (worksheet.getRow(LOMTConstant.EIGHTEEN).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_THREE) &&
					worksheet.getRow(LOMTConstant.NINETEEN).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_TWO) &&
					worksheet.getRow(LOMTConstant.TWENTY).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_THREE) &&
					worksheet.getRow(LOMTConstant.TWENTY_ONE).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_ONE) &&
					worksheet.getRow(LOMTConstant.TWENTY_TWO).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_THREE) &&
					worksheet.getRow(LOMTConstant.TWENTY_THREE).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_TWO) &&
					worksheet.getRow(25).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_THREE) &&
					worksheet.getRow(26).getCell(LOMTConstant.TWELEVE).getStringCellValue().trim()
						.equalsIgnoreCase(ReportsConstant.ONE_BY_TWO)) {
					} else {
						logger.log(LogStatus.FAIL, "Correlation score for Standard is not displayed as expected");
						logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1761_05_CORRELATION_VERIFY);
					}
			}
		...
		try {
			...
			if (worksheet.getRow(LOMTConstant.ZERO).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.ZERO).getCell(LOMTConstant.ONE).getStringCellValue() != null
					...
					count++;
					logger.log(LogStatus.FAIL, "TC-LOMT-1761- Title value does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761- Header : Title does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.ONE).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.ONE).getCell(LOMTConstant.ONE).getStringCellValue()
					...
					count++;
					logger.log(LogStatus.FAIL, "TC-LOMT-1761-User name does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : User does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.TWO).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (isValidFormat(
					...
					count++;
					logger.log(LogStatus.FAIL, "TC-LOMT-1761-Date/time of generation format does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : Date/time of generation does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.THREE).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.THREE).getCell(LOMTConstant.ONE).getStringCellValue()
					...
					count++;
					logger.log(LogStatus.FAIL, "TC-LOMT-1761-Alignments value(Central/Peripheral) does not match in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : Alignments does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FIVE).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : Content does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FIVE).getCell(LOMTConstant.EIGHT).getStringCellValue().trim()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : Standard does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SIX).getCell(LOMTConstant.ZERO).getStringCellValue().trim()
				...
				if (worksheet.getRow(LOMTConstant.SIX).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC-LOMT-1761-Program value does not match in exported file");
				}

			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : Program does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC-LOMT-1761-Course is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC-LOMT-1761-Header : Course does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.EIGHT).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.SEVEN).getCell(LOMTConstant.NINE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- Country is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Country does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Product does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.EIGHT).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.EIGHT).getCell(LOMTConstant.NINE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- Grade is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Grade does not match in exported file");
			}
			// Geographic Area or Country
			if (worksheet.getRow(LOMTConstant.NINE).getCell(LOMTConstant.ZERO).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.GEOGRAPHIC_AREA_OR_COUNTRY)) {
				if (worksheet.getRow(LOMTConstant.NINE).getCell(LOMTConstant.ONE) != null) {
					...
					logger.log(LogStatus.INFO, "TC_LOMT_1761- Geographic Area or Country is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Geographic Area or Country does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.TEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.TEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- State or Region is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : State or Region does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.ELEVENTH).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.ELEVENTH).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- Start Grade is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Start Grade does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.TWELEVE).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.TWELEVE).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- End Grade is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : End Grade does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.THIRTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.THIRTEEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- ISBN10 is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : ISBN10 does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FOURTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.FOURTEEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- ISBN13 is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : ISBN13 does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.FIFTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				if (worksheet.getRow(LOMTConstant.FIFTEEN).getCell(LOMTConstant.ONE) != null) {
					...
					count++;
					logger.log(LogStatus.FAIL, "TC_LOMT_1761- Type is null/empty in exported file");
				}
			} else {
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Type does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.ZERO).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : System UUID does not match in exported file");
			}
			// Content Reference
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.ONE).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Content Reference does not match in exported file");
			}
			// Start Page
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.TWO).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.START_PAGE)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Start Page does not match in exported file");
			}
			// End Page
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.THREE).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.END_PAGE)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : End Page does not match in exported file");
			}
			// Correlation Score
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.FOUR).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.CORRELATION_SCORE)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Correlation Score does not match in exported file");
			}
			// Strength
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.FIVE).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.STRENGTH)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Strength does not match in exported file");
			}
			// Peripheral Alignments
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.SIX).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Peripheral Alignments does not match in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.SEVEN) == null) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Column H is not blank in exported file");
			}
			...
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.EIGHT).getStringCellValue()
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Standard Strands does not match in exported file");
			}
			// Standard Topics
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.NINE).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.STANDARDS_TOPICS)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Standard Topics does not match in exported file");
			}
			// Standard Number
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.TEN).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.STANDARDS_NUMBER)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Standard Number does not match in exported file");
			}
			// ABGUID
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.ELEVENTH).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.AB_GUIDE)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : ABGUID does not match in exported file");
			}
			// Correlation Score
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.TWELEVE).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.CORRELATION_SCORE)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Correlation Score for Standard does not match in exported file");
			}
			// Strength
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.THIRTEEN).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.STRENGTH)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Strength for Standard does not match in exported file");
			}
			// Peripheral Alignments
			if (worksheet.getRow(LOMTConstant.SEVENTEEN).getCell(LOMTConstant.FOURTEEN).getStringCellValue()
					.equalsIgnoreCase(ReportsConstant.PERIPHERAL_ALIGNMENTS)) {
				...
				count++;
				logger.log(LogStatus.FAIL, "TC_LOMT_1761- Header : Peripheral Alignments for Standard does not match in exported file");
			}
		if(count>0){
			...
			logger.log(LogStatus.FAIL, "TC_LOMT_1761- Error occured during data verification : ");
			e.printStackTrace();
		}
	}
	...
	public void verifyReverseTocToStandardViaIntermediaryReportReportData(XSSFSheet worksheet, String reportName, ExtentTest logger) {
		try {
			...
			if (correlationCount == 0) {
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_08_CORRELATION_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_14_STANDARD_CORRELATION_VERIFY);
			} else {
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_08_CORRELATION_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_14_STANDARD_CORRELATION_VERIFY);
			}
			if (strengthCount == 0) {
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_03_STRENGTH_WEAK_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_04_STRENGTH_AVERAGE_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_05_STRENGTH_STRONG_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_06_STRENGTH_COMPLETE_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_09_STRENGTH_STANDARD_WEAK_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_10_STRENGTH_STANDARD_AVERAGE_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_11_STRENGTH_STANDARD_STRONG_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_12_STRENGTH_STANDARD_COMPLETE_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_13_STANDARD_PERIPHERAL_COUNT_VERIFY);
				logger.log(LogStatus.PASS, TestCases.TC_LOMT_1837_14_STANDARD_CORRELATION_VERIFY);
			} else {
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_03_STRENGTH_WEAK_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_04_STRENGTH_AVERAGE_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_05_STRENGTH_STRONG_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_06_STRENGTH_COMPLETE_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_09_STRENGTH_STANDARD_WEAK_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_10_STRENGTH_STANDARD_AVERAGE_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_11_STRENGTH_STANDARD_STRONG_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_12_STRENGTH_STANDARD_COMPLETE_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_13_STANDARD_PERIPHERAL_COUNT_VERIFY);
				logger.log(LogStatus.FAIL, TestCases.TC_LOMT_1837_14_STANDARD_CORRELATION_VERIFY);
			}
		} catch (Exception e) {
			logger.log(LogStatus.FAIL, "TC_LOMT-1837 Error occured during data verification : ");
			e.printStackTrace();
		}
	}
